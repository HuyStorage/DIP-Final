...
script_dir = 'FaceDetection'

onnx_detection_path = os.path.join(script_dir, 'face_detection_yunet_2023mar.onnx')
onnx_recognition_path = os.path.join(script_dir, 'face_recognition_sface_2021dec.onnx')
image_base_dir = os.path.join(script_dir, 'image')
svc_save_path = os.path.join(script_dir, 'svc.pkl')
